...
function UserSettings() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-xl bg-[#23232b] rounded-2xl shadow-2xl border border-[#29293a] p-4 sm:p-6 md:p-10 animate-fade-in">
        ...
        <div className="flex mb-8 gap-1 border-b border-gray-800">
          <button
            className={`flex-1 py-3 text-lg font-bold rounded-t-2xl transition-colors duration-200 ${
              activeTab === 'account'
                ? 'bg-gradient-to-r from-purple-700 to-purple-500 text-white shadow-lg'
                : 'bg-[#23232b] text-gray-400 hover:text-white'
            }`}
        ...
        {(msg || error) && (
          <div className="mb-4 flex justify-center">
            {msg && (
              <div className="px-4 py-2 rounded-lg bg-green-900/60 text-green-300 text-sm font-medium shadow-sm border border-green-700 animate-fade-in">
                {msg}
              </div>
            )}
            {error && (
              <div className="px-4 py-2 rounded-lg bg-red-900/60 text-red-300 text-sm font-medium shadow-sm border border-red-700 animate-fade-in">
                {error}
              </div>
            )}
          </div>
        ...
        {activeTab === 'account' && (
          <form onSubmit={handleAccountUpdate} className="space-y-10 mb-10 animate-fade-in">
            ...
            <div className="flex justify-end p-4">
              <Button
                type="submit"
                className="w-full sm:w-auto bg-gradient-to-r from-purple-700 to-purple-500 hover:from-purple-800 hover:to-purple-600 text-white px-8 py-3 rounded-xl font-bold shadow-lg transition text-md"
          ...
          <>
            ...
            <form onSubmit={handlePasswordUpdate} className="space-y-8 animate-fade-in">
              ...
              <div className="flex justify-end">
                <Button
                  type="submit"
                  className="w-full sm:w-auto bg-gradient-to-r from-blue-700 to-blue-500 hover:from-blue-800 hover:to-blue-600 text-white px-8 py-3 rounded-xl font-bold shadow-lg transition text-lg"
